...
<x-modal :id="$id" :maxWidth="$maxWidth" {{ $attributes }}>
    <div class="bg-white dark:bg-zinc-900 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <div class="sm:flex sm:items-start">
            <div class="mx-auto shrink-0 flex items-center justify-center size-12 rounded-full bg-red-100 dark:bg-red-500/10 sm:mx-0 sm:size-10">
    ...
    <div class="flex flex-row justify-end px-6 py-4 bg-gray-100 dark:bg-zinc-800/50 text-end gap-3">
        {{ $footer }}
    </div>
</x-modal>
